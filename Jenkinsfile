...
Thanks & Regards,<br>
ATT11May''', subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS! - Customized email report from Jenkins ', to: 'gouravatttest@gmail.com gouravjawale28@gmail.com'
            }
            }
        }
    }
